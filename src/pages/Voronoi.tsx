...
export function Voronoi() {
  return (
    ...
    >
      ...
      <p>
        2018 年有一篇发在 J. R. Soc. Interface 上的工作做过定量验证：蜻蜓翅膀的翅室分区
        确实能被 Voronoi 图很好地拟合。这不是说昆虫在算几何，
        而是说<strong>发育过程中「各自占地直到碰头」这条局部规则，数学上就等价于求 Voronoi 剖分</strong>。
        细胞按各自的中心往外长，长到相遇为止，边界自然落在垂直平分线上。
      </p>
      <p>
